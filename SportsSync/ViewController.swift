...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let apiUrl = "https://apiv2.allsportsapi.com/football/?met=Leagues&APIkey=4c8f425c876d47be6be85dc7a9ab9b4928e4e812a4d47f6ecd61163c3da0845f"
     ...
     //league "https://apiv2.allsportsapi.com/football/?met=Leagues&APIkey=7d926052ade18d04ebf895c2163d346ff5ad0906c66237812a5235cd56bd7257"
       ApiService.shared.fetchDataFromAPI(url: apiUrl) { result in
           ...
           case .success(let leagues):
               ...
               for leg in leagues {
                   print("the league is \(leg.countryName ?? "")")
               }
